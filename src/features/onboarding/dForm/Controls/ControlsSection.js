...
const ControlsSection = ({ objKey, index, schemaPropertyEdit = {} }) => {
        ...
        <div className="row" key={index}>
          <div className="col-md-12 form-group">
            <input
              ...
              data-id={objKey}
              onChange={(event) =>
                this.setState({ fieldEdit: { ...this.state.fieldEdit, propertyKey: event.target.value } })
              }
              className="form-control"
              placeholder={placeholder}
            />
  ...
  return (
    ...
    >
      {schema.schema.properties[objKey].title
        ? renderLabel("property-" + objKey, schema.schema.properties[objKey].title)
        : "Empty title"}
      <div className="form-group position-relative">
        <div className="pull-right-icons position-relative">
          {renderKeyObjectColumn("property-" + objKey, "Property")}
          <Badge color="primary position-absolute dform-type-badget">
            {getSpecificType(this.state.schema.properties[objKey])}
          </Badge>
        </div>
        ...
        <div className="d-flex dform-input-setting">
          <div className="vertical-center dform-input">
            ...
            >
              ...
              <div className="form-group">{renderKeyObjectEditColumn("property-" + objKey, "Property")}</div>
              ...
              <ControlTypeFactory
                ...
                index={index}
                schemaPropertyEdit={schemaPropertyEdit}
                objKey={objKey}
              />
            </ElementEditModal>
          </div>
