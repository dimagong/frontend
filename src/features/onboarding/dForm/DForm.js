...
const { getdFormsRequest, deletedFormRequest } = appSlice.actions;
    ...
    <div className="dform">
      <div>
        <Row className="app-user-list">
            ...
            <Card>
              <CardBody>
                <div className="d-flex justify-content-end flex-wrap mt-2">
                  <Button onClick={createDForm} color="primary d-flex-left">
                    Create
                  </Button>
                </div>
          ...
          <Col md="6">{dForm ? <DFormForm clearGridSelection={clearGridSelection} isCreate={isCreate} /> : null}</Col>
        </Row>
      </div>
    </div>
  );
