            ...
            <Row className="mx-0" col="12">
              <Col md="12" className="ml-0 pl-0">
                <div className="d-flex justify-content-end flex-wrap mt-2">
                  <Button className="mt-1" color="primary" onClick={createViewOnboarding}>
                    Create
                  </Button>
                </div>
              </Col>
              ...
              {manager.onboarding ? <UserOnboardingForm isCreate={isCreate} /> : null}
              {manager.onboarding && !isCreate.current ? <UserOnboardingDForm /> : null}
            </Row>
          </TabPane>
        </TabContent>
      </Col>
