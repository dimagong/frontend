...
const RMContextFeatureComponent = ({ selectableNodes, connectionsAndVersions, onResourceUpload }) => {
  const dumbData = [
    {
    ...
    <ContextFeatureTemplate contextFeatureTitle="File information">
      ...
      <div>
        {selectedFolder.name === dumbData[0].name ? (
          ...
          <SharedWith connections={connectionsAndVersions?.master_schema_connections || []} />
        )}
      </div>
