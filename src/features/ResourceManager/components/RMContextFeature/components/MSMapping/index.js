  ...
  return (
    <div>
      <div className="d-flex align-items-center justify-content-between">
        <div className="title">Document Mapping</div>
      </div>
      {document?.id ? (
        <div className={"ms-mapping"}>
            ...
            <div className={"d-flex align-items-center justify-content-between"}>
              ...
              <Select
                options={versions.map((item) => {
                  return { value: item, label: item.name + " " + item.version };
                })}
            ...
            <div className={"ms-mapping-main-container"}>
              {document.types.map((element) => (
                <div className={"ms-mapping-main-container-item d-flex align-items-center justify-content-between"}>
                  ...
                  <Select
                    options={document.types.map((item) => {
                      return { value: item, label: "MS.ValidPath.profile." + item };
                    })}
                    styles={selectStyles}
          ...
          <div className={"ms-mapping-footer d-flex align-items-center justify-content-between"}>
            <Button variant="primary" className={"ms-mapping-footer-cancel"} onClick={() => {}}>
              Cancel
            </Button>
            <Button variant="primary" className={"ms-mapping-footer-save"} onClick={() => {}}>
              Save
            </Button>
          </div>
        </div>
