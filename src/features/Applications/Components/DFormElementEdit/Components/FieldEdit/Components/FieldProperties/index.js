      ...
      return (
        <div className="w-100">
          <Checkbox
            ...
            label="Is required"
            id={`${index}-${column}`}
            onChange={() => {handleChange("isRequired", !element.isRequired)}}
    ...
    const renderLabelShowing = (column) => {
      return <div className="w-100">
        <Checkbox
          ...
          label="Label showing"
          id={`${index}-${column}`}
          onChange={() => {handleChange("isLabelShowing", !element.isLabelShowing)}}
          ...
          <div className=" dform-input-setting">
            <div className="vertical-center dform-input">
                <div className="form-group">
                  ...
                  >
                    {["Text","TextArea","Select"].map((type, indexType) => <option
                      key={indexType}>{type}</option>)}
                  </select>
                </div>
                {renderPropertyKey()}
