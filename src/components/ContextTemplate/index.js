        ...
        <div style={{ paddingRight: "15px" }}>
          <div className={"context-template_header"}>
            <div className={"d-flex"}>
              ...
              {!!contextName && <div className={"context-template_header_survey-name"}>{contextName}</div>}
            </div>
            {!!contextHeaderIcon && <div className={"context-template_header_edit-icon"}>{contextHeaderIcon}</div>}
          </div>
