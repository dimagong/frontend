      ...
      case 2:
        return (
          <p className={"filter-text"}>
            Filtering by <span className={"blue"}>{filterOptionsToText(selectedFilters[0].selected)}</span> and <span className={"blue"}>{filterOptionsToText(selectedFilters[1].selected)}</span>
          </p>
        );
