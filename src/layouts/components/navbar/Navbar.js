                ...
                <div className="bookmark-wrapper">
                  <NavLink to="/" className="navbar-brand logo d-flex align-items-center">
                    ...
                    {!userProfile.permissions.logo?.base64 ? (
                      <img onClick={handleOrgPictureClick} className="brand-logo "
                           src={userProfile.permissions.logo_path} alt="main org logo" />
                    ) : (
                      <img onClick={handleOrgPictureClick} className="brand-logo "
                           src={userProfile.permissions.logo?.base64} alt="main org logo" />
                    )}
