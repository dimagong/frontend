...
export const selectOrganizations = (state) => [
  ...state.app.organizations.corporation,
  ...state.app.organizations.network,
  ...state.app.organizations.member_firm,
];
...
export const selectOrganizationEdit = (state) =>
  selectOrganizations(state).filter(
    (org) =>
