...
export const getMasterSchemaFieldsForMemberFirmUrl = (memberFirmId) =>
  `/api/member-firm/${memberFirmId}/master-schema-fields`;
export const getMemberFirmFormFieldsUrl = (memberFirmId) => `/api/member-firm/${memberFirmId}/field-structure`;
export const updateMemberFirmFormValuesUrl = (memberFirmId) =>
  `/api/member-firm/${memberFirmId}/master-schema-field-values`;
...
export const getMemberFirmActivitiesUrl = (memberFirmId) =>
  `/api/user/member-firm-dashboard?member_firm_ids[]=${memberFirmId}`;

export const addFormFieldToMemberFirmUrl = (memberFirmId) => `/api/member-firm/${memberFirmId}/field-structure`;
export const createMasterSchemaFieldForMemberFirmUrl = (memberFirmId) =>
  `/api/member-firm/${memberFirmId}/master-schema-field`;
