...
import {
  ...
  createMasterSchemaFieldForMemberFirmUrl,
} from "./constants";
...
const memberFirmsApi = {
  ...
  createMasterSchemaFieldForMemberFirm(payload) {
    return requestLayout(createMasterSchemaFieldForMemberFirmUrl(payload.member_firm_id), "POST", payload.data);
  },
};
