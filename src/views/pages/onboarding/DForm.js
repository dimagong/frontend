                                            ...
                                            <div>
                                                {
                                                    this.state.isStateConfig ?
                                                        <EyeOff size={15} className="cursor-pointer mr-1" onClick={() => this.changeStateConfig(false)} />
                                                        :
                                                        <Eye size={15} className="cursor-pointer mr-1" onClick={() => this.changeStateConfig(true)} />
                                                }
