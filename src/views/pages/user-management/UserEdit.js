                ...
                <CardTitle className="font-weight-bold">                  
                        <div className="d-flex edit-btn-trigger">
                                ...
                                this.isFieldEdit('name') ?
                                    <FormGroup className="position-absolute input-divider-right" style={{ 'margin-bottom': '0', 'padding': 0, top: '-9px', left: '-2px', 'min-width': '240px' }}>
                                        <Input
                                        ...
                                        />
                                        <div className="form-control-position" style={{ 'margin-bottom': '0', 'padding': 0 }} onClick={() => this.editFieldSave()}>
                                            <Check className="bg-hover-icon" size={15} />
                                        </div>
                                        <div className="form-control-position" style={{ 'margin-bottom': '0', 'padding': 0, 'margin-right': '32px' }} onClick={() => this.editFieldClose()}>
                                    ...
                                    <Row className="mt-1">
                                        <Col sm="9" md="6" lg="6">
                                            <div className="users-page-view-table">
                                                <div className="d-flex edit-btn-trigger">
                                                    <div className="font-weight-bold-lighter column-sizing-user-info" onClick={() => this.editField('number')}>Number</div>
                                                    <div className="edit-container">
                                                        {
                                                            this.isFieldEdit('number') ?
                                                                <FormGroup className="position-absolute input-divider-right" style={{ 'margin-bottom': '0', 'padding': 0, top: '-9px', left: '-2px' }}>
                                                                    <Input
                                                                        style={{ 'padding-right': 'calc(1.25 * 1em + 1.4rem + 1px + 32px)' }}
                                                                        autoFocus
                                                                        type="text"
                                                                ...
                                                                : <div onClick={() => this.editField('number')}>{number} <Edit2 className="edit-btn" size={15} /></div>
                                                        }
                                                    </div>
                                                </div>
                                                <div className="d-flex edit-btn-trigger">
                                                    <div className="font-weight-bold-lighter column-sizing-user-info" onClick={() => this.editField('email')}>Email</div>
                                                    <div className="edit-container">
                                                        {
                                                            this.isFieldEdit('email') ?
                                                                ...
                                                                : <div onClick={() => this.editField('email')}>{email}<Edit2 className="edit-btn" size={15} /></div>
                                                        }
                                                    </div>
                                                </div>
                                                <div className="d-flex edit-btn-trigger">
                                                    <div className="font-weight-bold-lighter column-sizing-user-info" onClick={() => this.editField('valid_until')}>Valid until</div>
                                                    <div className="edit-container">
                                                        {
                                                            this.isFieldEdit('valid_until') ?
                                                                ...
                                                                :
                                                                <div onClick={() => this.editField('valid_until')}>{valid_until}<Edit2 className="edit-btn" size={15} /></div>
                                                        }
                                                ...
                                                <div className="d-flex mb-1">
                                                    ...
                                                    <div className="full-width">
                                                        ...
                                                        <Select
                                                            ...
                                                            onChange={(values) => { this.onSelectRolesChange(values) }}
                                                ...
                                                <div className="d-flex mb-1">
                                                    ...
                                                    <div className="full-width">
                                                        ...
                                                        <Select
                                                            ...
                                                            onChange={(values) => { this.onSelectGroupsChange(values) }}
                                                            className="fix-margin-select"
                                                            classNamePrefix="select"
                                                            id="languages"
                                                        />
                                                ...
                                                <div className="d-flex">
                                                    ...
                                                    <div className="full-width">
                                                        ...
                                                        <Select
                                                            ...
                                                            className="fix-margin-select"
                                                            onChange={(values) => { this.setModules(values) }}
                                                            classNamePrefix="select"
                                                            id="languages"
                                                        />
                                                    </div>
                                                ...
                                                <Row className="mt-1">
                                                            ...
                                                            <div className="d-flex mb-1">
                                                                ...
                                                                <div className="full-width">
                                                                    ...
                                                                    <Select
                                                                        ...
                                                                        className="fix-margin-select"
                                                                        onChange={(values) => { this.setDForm(values) }}
                                                                        classNamePrefix="select"
                                                                        id="languages"
                                                                    />
                                                                </div>
                                                            ...
                                                            <div className="d-flex mb-1">
                                                                ...
                                                                <div className="full-width">
                                                                    ...
                                                                    <Select
                                                                        ...
                                                                        onChange={(values) => { this.setReviewers(values) }}
                                                                        className="fix-margin-select"
                                                                        classNamePrefix="select"
                                                                        id="languages"
                                                                    />
                                                            ...
                                                            <div className="d-flex">
                                                                ...
                                                                <div className="full-width">
                                                                    ...
                                                                    <Select
                                                                        ...
                                                                        onChange={(values) => { this.setWorkflow(values) }}
                                                                        className="fix-margin-select"
                                                                        classNamePrefix="select"
                                                                        id="languages"
                                                                    />
                                                    ...
                                                    <Col>
                                                    {
                                                        ...
                                                        <div className="d-flex justify-content-end flex-wrap mt-2">
                                                            <Button className="mt-1" color="primary" onClick={() => { this.submitData() }}>Save</Button>
                                                        </div>
                                                    }         
                                                    {
                                                        !this.props.user.onboarding ? null :
                                                        <div className="d-flex justify-content-end flex-wrap mt-2">
                                                            <Button className="mt-1" color="danger" onClick={() => { this.deleteOnboarding() }}>Delete onboarding</Button>
                                                        </div>
                                                    }           
                                                    </Col>
                                                                ...
                                                                <Card className="border">
                                                                    ...
                                                                    <hr />
                                                                        <FormCreate
                                                                            ...
                                                                            dForm={this.props.user.onboarding.d_form} isStateConfig={false}
                                                                        ></FormCreate>
                                                                    </CardBody>
                                                                </Card>
                                                            </Col>
